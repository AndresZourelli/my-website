...
docker push gcr.io/charged-formula-262616/andreszourelli/web-client
docker push gcr.io/charged-formula-262616/andreszourelli/web-nginx
docker push gcr.io/charged-formula-262616/andreszourelli/web-server

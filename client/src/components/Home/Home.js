			...
			<div className="App">
				...
				<div className="nameCard">
					...
					<h4>
						...
						dabble in other software development fields, such as Python and C/C++. I want to persue my
						passion for software development as a career so I am in the process of completing my degree in
